/*
 * Generated by JasperReports - 2/5/17 11:19 AM
 */
 ...
 *
 */
public class ReportIncoming_1486268347402_673688 extends JREvaluator
{
    ...
    private JRFillParameter parameter_tgl5 = null;
    private JRFillParameter parameter_REPORT_MAX_COUNT = null;
    private JRFillParameter parameter_tgl4 = null;
    ...
    private JRFillField field_Vendor = null;
    private JRFillField field_RejectQty = null;
    ...
    private void initParams(Map pm)
    {
        ...
        parameter_tgl5 = (JRFillParameter)pm.get("tgl5");
        parameter_REPORT_MAX_COUNT = (JRFillParameter)pm.get("REPORT_MAX_COUNT");
        parameter_tgl4 = (JRFillParameter)pm.get("tgl4");
    ...
    private void initFields(Map fm)
    {
        ...
        field_Vendor = (JRFillField)fm.get("Vendor");
        field_RejectQty = (JRFillField)fm.get("RejectQty");
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.sql.Date)parameter_tgl4.getValue()); //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.sql.Date)parameter_tgl5.getValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.lang.String)field_ShortDocument.getValue()); //$JR_EXPR_ID=10$
                break;
            }
            case 11 : 
            {
                value = ((java.lang.String)field_NoDoc.getValue()); //$JR_EXPR_ID=11$
                break;
            }
            case 12 : 
            {
                value = ((java.lang.String)field_NoDo.getValue()); //$JR_EXPR_ID=12$
                break;
            }
            case 13 : 
            {
                value = ((java.sql.Date)field_DateNoDo.getValue()); //$JR_EXPR_ID=13$
                break;
            }
            case 14 : 
            {
                value = ((java.lang.String)field_ItemCode.getValue()); //$JR_EXPR_ID=14$
                break;
            }
            case 15 : 
            {
                value = ((java.lang.String)field_Description.getValue()); //$JR_EXPR_ID=15$
                break;
            }
            case 16 : 
            {
                value = ((java.lang.String)field_UM.getValue()); //$JR_EXPR_ID=16$
                break;
            }
            case 17 : 
            {
                value = ((java.lang.Double)field_Price.getValue()); //$JR_EXPR_ID=17$
                break;
            }
            case 18 : 
            {
                value = ((java.lang.String)field_GoodQty.getValue()); //$JR_EXPR_ID=18$
                break;
            }
            case 19 : 
            {
                value = ((java.sql.Date)field_DateNoDoc.getValue()); //$JR_EXPR_ID=19$
                break;
            }
            case 20 : 
            {
                value = ((java.lang.String)field_Vendor.getValue()); //$JR_EXPR_ID=20$
                break;
            }
            case 21 : 
            {
                value = "Page " + ((java.lang.Integer)variable_PAGE_NUMBER.getValue()); //$JR_EXPR_ID=21$
                break;
            }
            case 22 : 
            {
                value = new java.util.Date(); //$JR_EXPR_ID=22$
                break;
            }
           default :
           {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 10 : 
            {
                value = ((java.lang.String)field_ShortDocument.getOldValue()); //$JR_EXPR_ID=10$
                break;
            }
            case 11 : 
            {
                value = ((java.lang.String)field_NoDoc.getOldValue()); //$JR_EXPR_ID=11$
                break;
            }
            case 12 : 
            {
                value = ((java.lang.String)field_NoDo.getOldValue()); //$JR_EXPR_ID=12$
                break;
            }
            case 13 : 
            {
                value = ((java.sql.Date)field_DateNoDo.getOldValue()); //$JR_EXPR_ID=13$
                break;
            }
            case 14 : 
            {
                value = ((java.lang.String)field_ItemCode.getOldValue()); //$JR_EXPR_ID=14$
                break;
            }
            case 15 : 
            {
                value = ((java.lang.String)field_Description.getOldValue()); //$JR_EXPR_ID=15$
                break;
            }
            case 16 : 
            {
                value = ((java.lang.String)field_UM.getOldValue()); //$JR_EXPR_ID=16$
                break;
            }
            case 17 : 
            {
                value = ((java.lang.Double)field_Price.getOldValue()); //$JR_EXPR_ID=17$
                break;
            }
            case 18 : 
            {
                value = ((java.lang.String)field_GoodQty.getOldValue()); //$JR_EXPR_ID=18$
                break;
            }
            case 19 : 
            {
                value = ((java.sql.Date)field_DateNoDoc.getOldValue()); //$JR_EXPR_ID=19$
                break;
            }
            case 20 : 
            {
                value = ((java.lang.String)field_Vendor.getOldValue()); //$JR_EXPR_ID=20$
                break;
            }
            case 21 : 
            {
                value = "Page " + ((java.lang.Integer)variable_PAGE_NUMBER.getOldValue()); //$JR_EXPR_ID=21$
                break;
            }
            case 22 : 
            {
    ...
    public Object evaluateEstimated(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 21 : 
            {
                value = "Page " + ((java.lang.Integer)variable_PAGE_NUMBER.getEstimatedValue()); //$JR_EXPR_ID=21$
                break;
            }
            case 22 : 
            {
