...
public class AddCustomerController implements Initializable {
	...
	@FXML
    private TextField tfCustomerNpwp;
	@FXML
    private TextField tfCustomerSkep;
    @FXML
    ...
    @FXML
    private void btnSaveCustomerOnAction(ActionEvent event) {
    	customer.customerName = tfCustomerName.getText().trim();
        customer.customerAddress = taCustomerAddress.getText().trim();
        customer.customerNpwp = tfCustomerNpwp.getText().trim();
        customer.customerSkep = tfCustomerSkep.getText().trim();
    ...
    @FXML
    private void btnUpdateCustomerOnAction(ActionEvent event) {
    ...
    public void viewDetails(){
         ...
         tfCustomerNpwp.setText(customer.customerNpwp);
         tfCustomerSkep.setText(customer.customerSkep );
    }
}
