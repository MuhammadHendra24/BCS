...
import controller.application.settings.DeptSettingController;
...
public class SettingsController implements Initializable {
    ...
    private void miOrganizeOnAction(ActionEvent event) throws IOException {
        System.out.println(userID);
        lblCurrentStatus.setText("Departement-Section");
        
        DeptSettingController depSetting = new DeptSettingController();
        userNameMedia useridMedia = new userNameMedia();
        
        FXMLLoader fXMLLoader = new FXMLLoader();
        fXMLLoader.load(getClass().getResource("/view/application/settings/Departtement.fxml").openStream());
        
        useridMedia.setId(userID);
        
        DeptSettingController deptSettingController = fXMLLoader.getController();
        deptSettingController.setUsrIdMedia(useridMedia);
        deptSettingController.showDetails();
        spSettingContent.getChildren().clear();
