/*
 * Generated by JasperReports - 1/30/17 12:59 AM
 */
 ...
 *
 */
public class ReportIncomingByDoc_1485712762120_991214 extends JREvaluator
{
    ...
    private JRFillParameter parameter_TEST = null;
    ...
    private void initParams(Map pm)
    {
        ...
        parameter_TEST = (JRFillParameter)pm.get("TEST");
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.String)field_ShortDocument.getValue()); //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.String)field_NoDoc.getValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.lang.String)field_NoDo.getValue()); //$JR_EXPR_ID=10$
                break;
            }
            case 11 : 
            {
                value = ((java.sql.Date)field_DateNoDo.getValue()); //$JR_EXPR_ID=11$
                break;
            }
            case 12 : 
            {
                value = ((java.lang.String)field_Vendor.getValue()); //$JR_EXPR_ID=12$
                break;
            }
            case 13 : 
            {
            ...
            case 19 : 
            {
                value = "Page " + ((java.lang.Integer)variable_PAGE_NUMBER.getValue()); //$JR_EXPR_ID=19$
                break;
            }
            case 20 : 
            {
                value = new java.util.Date(); //$JR_EXPR_ID=20$
                break;
            }
           default :
           {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.String)field_ShortDocument.getOldValue()); //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.String)field_NoDoc.getOldValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.lang.String)field_NoDo.getOldValue()); //$JR_EXPR_ID=10$
                break;
            }
            case 11 : 
            {
                value = ((java.sql.Date)field_DateNoDo.getOldValue()); //$JR_EXPR_ID=11$
                break;
            }
            case 12 : 
            {
                value = ((java.lang.String)field_Vendor.getOldValue()); //$JR_EXPR_ID=12$
                break;
            }
            case 13 : 
            {
            ...
            case 19 : 
            {
                value = "Page " + ((java.lang.Integer)variable_PAGE_NUMBER.getOldValue()); //$JR_EXPR_ID=19$
                break;
            }
            case 20 : 
            {
    ...
    public Object evaluateEstimated(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 19 : 
            {
                value = "Page " + ((java.lang.Integer)variable_PAGE_NUMBER.getEstimatedValue()); //$JR_EXPR_ID=19$
                break;
            }
            case 20 : 
            {
